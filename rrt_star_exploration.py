# -*- coding: utf-8 -*-
"""
Created on Sat Apr 29 11:25:03 2023
...
from dpp.methods.rrt_star_exploration import RRTStarExploration
...
def main():
    ...
    rrt_star = RRTStarExploration(car, max_steps=50, pick_target=10, check_dubins=1, max_iterations=1000)

    t = time()

    nodes = rrt_star.search_path()
